  ...
  var analysts = references.users
    ...
    .map(function (value, index) {
      return __assign(__assign({}, value), {
        email: 'admin'.concat(index, '@gmail.com'),
        password: 'admin'.concat(index),
      })
    })
...
var getUsers = function () {
  return references.users.map(function (value, index) {
    return {
      name: value,
      email:
        value !== undefined
      ...
      address: {
        ...
        state:
          references.state[
            generateRandomNumber(0, references.state.length - 1)
          ],
        neighborhood:
        ...
        postalCode: ''
          .concat(generateRandomNumber(10000, 99999), '-')
          .concat(generateRandomNumber(100, 999)),
      },
...
var getFeatures = function () {
  var result = references.features.map(function (value, index) {
    return {
      id: index,
      name: value,
    }
